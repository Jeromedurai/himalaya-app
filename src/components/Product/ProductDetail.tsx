      ...
      <div className="grid items-start grid-cols-1 lg:grid-cols-5 gap-8">
        ...
        <div className="lg:col-span-2">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <button type="button" className="min-w-[200px] px-4 py-2.5 border border-gray-800 bg-transparent hover:bg-gray-50 text-gray-800 text-sm font-semibold rounded">Add to Bag</button>
          </div>
        </div>
      </div>
                ...
                <div className="p-6 lg:max-w-6xl max-w-2xl mx-auto">
                    <div className="grid items-start grid-cols-1 lg:grid-cols-2 gap-8">
                        <div className="w-full lg:sticky top-0 sm:flex gap-2">
                            <div className="max-sm:flex max-sm:mb-4 max-sm:gap-4">
